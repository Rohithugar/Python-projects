...
*******************************************************************************
''')
print("Welcome to the treasure islamd")
print("Your mission is to find the treasure")
choice1 = input('You\'re at a crossroad, where do you go? Type "left" or "right".\n').lower()
...
if choice1 == "left":
    ...
    if choice2 == "wait":
        ...
        print("Ypu got attacked by an angry trout. Game over")
else:              
